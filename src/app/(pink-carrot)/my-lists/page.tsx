...
const MyCarrotsPage = async () => {
  return (
    <section className="min-h-[calc(100vh-5rem)] bg-zinc-950">
      <div className="container mx-auto flex min-h-[calc(100vh-5rem)] items-stretch justify-center px-3 py-8 sm:px-5 sm:py-10">
        <div className="w-full max-w-xl rounded-2xl border border-zinc-600/30 bg-zinc-800 px-5 py-8 sm:px-8 sm:py-10 shadow-2xl shadow-black/40 md:px-10 md:py-12">
          <header className="mb-8 w-full text-center">
            <h1 className="text-2xl font-semibold text-zinc-100">Chests</h1>
          </header>
